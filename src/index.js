...
(function (root, factory) {
     ...
     *
     * Usage:
     *   AgentBoxComponents.CommandShowcase.init('#commandShowcase');
     */
    var CommandShowcase = {
        _commands: [
         ...
         * @returns {Array<{text: string, icon: string, category: string}>}
         */
        ...
        /**
         * Set custom commands.
         * @param {Array<{text: string, icon: string, category: string}>} cmds
         */
        ...
        /**
         * Get the index of the command currently being displayed.
         * @returns {number}
         */
        ...
        /**
         * Check whether the typewriter is currently animating.
         * @returns {boolean}
         */
        ...
        /**
         * Check whether the showcase is paused.
         * @returns {boolean}
         */
        isPaused: function () {
        ...
        /**
         * Pause the animation cycle. The current typing/erasing action
         * finishes but no new cycle starts.
         */
        pause: function () {
        ...
        /**
         * Resume a paused animation cycle.
         */
        resume: function () {
        ...
        /**
         * Skip to a specific command by index.
         * @param {number} index
         */
        ...
        /**
         * Run one type-pause-erase-pause cycle, then advance to the next command.
         */
        _cycle: function () {
            if (CommandShowcase._isPaused) return;
        ...
        /**
         * Stop the animation and clear all timers.
         */
        stop: function () {
            if (CommandShowcase._timer) {
                clearTimeout(CommandShowcase._timer);
        ...
        /**
         * Initialize the command showcase.
         * @param {string|Element} container - CSS selector or DOM element
         * @param {Object} [options] - Override typeSpeed, eraseSpeed, pauseAfterType, pauseAfterErase
         */
        init: function (container, options) {
            var el = typeof container === 'string' ? qs(container) : container;
            if (!el) return;
            ...
            // Build DOM structure if container is empty
            ...
            CommandShowcase._cursorEl = el.querySelector('.command-cursor');
